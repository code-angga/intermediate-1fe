...
//       <div
//         onClick={() => scroll("left")}
//         className="absolute left-0 top-1/2 -translate-y-1/2 z-40 bg-black/70 p-2 rounded-full text-white cursor-pointer"
//       >
//         <FaChevronLeft />
//       </div>
...
//       <div
//         onClick={() => scroll("right")}
//         className="absolute right-0 top-1/2 -translate-y-1/2 z-40 bg-black/70 p-2 rounded-full text-white cursor-pointer"
//       >
//         <FaChevronRight />
//       </div>
...
//       >
//         {movies.map((movie) => (
//           <div key={movie.id} className="relative min-w-[160px] group">
//             {/* POSTER */}
//             <img
//               src={
//                 movie.poster_path
...
//               }
//               alt={movie.title}
//               className="w-full h-56 object-cover rounded-lg group-hover:opacity-40 transition"
//             />

//             {/* HOVER CARD */}
//             <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-[280px] bg-zinc-900 rounded-xl opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition z-50">
//               <img
//                 src={
//                   movie.backdrop_path
//                     ? `${IMAGE_URL}${movie.backdrop_path}`
